...
export async function GET(
	req: NextRequest,
	context: { params: { id: string; chapter: string; img: string } }
) {
	const { id, chapter, img } = context.params;
	const url = `https://imgs-2.2xstorage.com/${encodeURIComponent(id)}/${chapter}/${img}.webp`;
